...
import 'package:college_result_app/models/alert.dart';
import 'package:college_result_app/widgets/countdown_painter.dart';
import 'dart:math';
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        int hoursLeft = random.nextInt(100);

        double percent = hoursLeft / 100;
